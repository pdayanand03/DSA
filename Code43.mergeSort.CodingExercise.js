...
function merge(array1,array2,comparator=null) {
  if(!comparator){
    comparator = (a,b) =>a-b;
  }
    let i=0,j=0;
...
function mergeSort(array, comparator=null) {
  function mergeSortHelper(array) {
    if(array.length<=1){
      return array;
    }
    let mid = Math.floor(array.length/2);
    return merge(mergeSortHelper(array.slice(0,mid)), mergeSortHelper(array.slice(mid)),comparator)
  }
